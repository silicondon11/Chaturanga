...
public class HighlighterMover : MonoBehaviour
{
    public IEnumerator MoveHighlighterCoroutine(GameObject item, List<UnityEngine.Vector3[]> positionsArrays, int destPosIdx, int destPosArrayIdx, int moveSpeed)
    {
